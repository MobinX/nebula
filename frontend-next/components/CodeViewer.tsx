...
import { Copy, CopyCheck, Eye, MessageCircle, } from 'lucide-react';



export default function CodeViewer({ code, isShowingMsgCard, setCardState }: { setCardState: Function, isShowingMsgCard: boolean, code: string }) {
    ...
    return (
        <div className={`${!isShowingMsgCard == true ? "mockup-code  border-base-300 border w-full h-full rounded-3xl" : "hidden  md:block  md:mockup-code border-base-300 border w-full h-full rounded-3xl"}`}>
            <div className="flex items-center gap-3 absolute top-[15px] right-[15px]">
                ...
                <div onClick={() => setCardState(true)} className="text-primary-content md:hidden">
